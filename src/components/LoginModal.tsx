    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          <Button 
            onClick={() => handleSignIn('google000')} 
            disabled={isLoading}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Vous pouvez aussi choisir un profil utilisateur pour tester les différents rôles
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <Button 
                ...
                variant="outline"
              >
                {isLoading ? 'Connexion...' : 'Se connecter avec ce profil'}
              </Button>
            </CardContent>
          </Card>
